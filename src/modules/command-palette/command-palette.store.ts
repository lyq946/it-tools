...
export const useCommandPaletteStore = defineStore('command-palette', () => {
  ...
  const searchOptions: PaletteOption[] = [
    ...
    },
    {
      ...
      href: 'https://tools.cxyroad.com',
      category: 'External',
      description: 'View the source code of dev-tools-hub on Github.',
      keywords: ['github', 'repo', 'repository', 'source', 'code'],
      icon: GithubIcon,
    },
    {
      name: 'Report a bug or an issue',
      description: 'Report a bug or an issue to help improve dev-tools-hub.',
      href: 'https://tools.cxyroad.com',
      category: 'Actions',
    ...
    {
      name: 'About',
      description: 'Learn more about Dev-Tools-Hub.',
      to: '/about',
      category: 'Pages',

...
monaco.editor.defineTheme('dev-tools-hub-dark', {
  base: 'vs-dark',
  inherit: true,
  rules: [],
  colors: {
...
monaco.editor.defineTheme('dev-tools-hub-light', {
  base: 'vs',
  inherit: true,
  rules: [],
  colors: {
...
watch(
  ...
  isDarkTheme => monaco.editor.setTheme(isDarkTheme ? 'dev-tools-hub-dark' : 'dev-tools-hub-light'),
  { immediate: true },
);
